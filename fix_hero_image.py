...
old_top_text = """  const topTextNode = (
    <div className="flex flex-col items-center justify-center pt-20">
      ...
      <h1 className="text-[clamp(2.5rem,5vw,5rem)] font-extrabold text-white leading-[1.1] mb-6 max-w-6xl">
        5 Crore Cases Are Stuck in Indian Courts.<br />
        <span className="text-gray-400">Yours Doesn't Have to Be One of Them.</span>
      </h1>
      <p className="text-lg md:text-2xl text-gray-300 max-w-4xl font-normal mb-10 leading-relaxed">
...
new_top_text = """  const topTextNode = (
...
content = content.replace(old_top_text, new_top_text)
