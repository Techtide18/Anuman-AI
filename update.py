...
start_marker = "{/* 4. Data & Analytics Insights */}"
end_marker = "{/* 5. Precedents & Legal Strategy */}"

start_idx = content.find(start_marker)
end_idx = content.find(end_marker)

new_charts = """{/* 4. Data & Analytics Insights */}
...
content = content[:start_idx] + new_charts + content[end_idx:]
